                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 0 30px;">
                                    <h2 style="font-size: 18px; color: #002c72;text-transform: uppercase; font-weight: 600; margin: 0; text-align: center;">'Trade Initiated - {{$data['buy_or_sell']}} - {{$data['client_code']}}</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;color: black">
                                       Scheme Code: {{$data['scheme_code']}}<br>
                                       Maturity Date: {{$data['maturity_date']}}<br>
                                       Face Value: {{$data['face_value']}}<br>
                                       Settlement Amount: {{$data['invest_amount']}}<br>
                                       Price: {{$data['price']}}<br>
                                       Yield: {{$data['yield']}}<br>
                                    </p>
                                </td>
